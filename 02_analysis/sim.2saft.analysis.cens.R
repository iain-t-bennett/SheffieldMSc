...
# Outputs: data/raw/sim.2saft.res.cens.rData
...
fsim.2saft <- function(parms){
    ...
    fdf <- mutate(df.2saft.res,
                           ...
                           t.cens.nmod    = pmin(t.censor, t.censor * exp(-null.coef)),
                           cens.os.nmod   = ifelse(x.trt==0, pmin(corr.os.nmod, t.cens.nmod), os.t),
                           cens.os.nmod.e = ifelse(x.trt==0, ifelse(cens.os.nmod==t.cens.nmod, 0, os.e), os.e),
                           
                           t.cens.cmod  = pmin(t.censor, t.censor * exp(-corr.coef)),
                           cens.os.cmod   = ifelse(x.trt==0, pmin(corr.os.cmod, t.cens.cmod), os.t),
                           cens.os.cmod.e = ifelse(x.trt==0, ifelse(cens.os.cmod==t.cens.cmod, 0, os.e), os.e)
    )
...
sim.2saft.res.cens.df <- rbind(sim2.2saft.res.df, sim3.2saft.res.df, sim4.2saft.res.df)

############# save


save(sim.2saft.res.cens.df, file = "data/raw/sim.2saft.res.cens.rData")
